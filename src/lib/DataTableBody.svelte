<script lang="ts">
    import type { DataTableBodyProps } from "../interface/DataTableBodyProps";
    import DataTableRows from "./DataTableRows.svelte";

    const { tableData, colSpan, columnKeys, rowExpansion, striped = false }: DataTableBodyProps = $props();
</script>
